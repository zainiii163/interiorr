...
import {
  ...
  ShieldCheck, Briefcase, ClipboardList, Compass, TrendingUp, UserCircle,
} from 'lucide-react';
...
export default function AdminLayout() {
  ...
  const navItems = [
    ...
    { name: 'Clients', path: '/admin/clients', icon: UserCircle },
    ...
    { name: 'Project Timelines', path: '/admin/project-timelines', icon: TrendingUp },
