...
export default function About() {
  ...
  const subtitle = settings.aboutSubtitle;
    ...
    <div className="page-offset pb-20">
      <section className="bg-stone-900 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          {body && <p className="text-stone-300 mt-4 max-w-2xl mx-auto text-base">{body}</p>}
        </div>
      </section>
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="font-serif text-3xl font-bold text-stone-900 mt-2">{title}</h2>
            {body && <p className="text-stone-600 mt-4 leading-relaxed text-sm">{body}</p>}
            {bullets.length > 0 && (
