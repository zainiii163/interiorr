/** Hulul Al Madina Interiors (HAMTS) — default site branding. */
export const BRAND_DEFAULTS = {
  companyName: 'Hulul Al Madina Interiors',
  tagline: 'Maintenance • Renovation • Reliable Solutions',
  phone: '+971 56 178 7007',
  whatsapp: '971561787007',
  ...
  seo: {
    ...
    defaultDescription:
      'Hulul Al Madina Interiors (HAMTS) — maintenance, renovation, fit-out and technical services in Deira, Dubai. حلول المدينة للخدمات الفنية.',
    ogImage: '/logo.jpg',
  },
  ...
  aboutBody:
    'Hulul Al Madina Interiors (HAMTS) provides maintenance, renovation, and interior technical services for villas, apartments, and commercial spaces across Dubai. From painting and carpentry to full fit-out and reliable repairs, our Deira team delivers practical solutions with clear communication.',
  aboutBullets: [
  ...
  aboutImage: 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?auto=format&fit=crop&w=1000&q=80',
  mission:
  ...
  skills: [
    { label: 'Maintenance & Repairs', value: 95 },
    { label: 'Renovation & Fit-Out', value: 90 },
    { label: 'Painting & Finishes', value: 88 },
    { label: 'Carpentry & Joinery', value: 85 },
  ],
  ...
  ctaBandImage: 'https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&w=2000&q=80',
